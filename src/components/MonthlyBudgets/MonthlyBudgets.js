...
class MonthlyBudgets extends Component {
    ...
    async componentDidMount() {
        ...
        const response = await axios.get(
            "http://3.89.252.45:3001/app/userMonthlyBudget",
            {
                headers: {
    ...
    handleMonthChange = async (monthdata) => {
        ...
        const token = localStorage.getItem("token");
        const response = await axios.get(
            `http://3.89.252.45:3001/app/userMonthlyBudget/${month}/${this.state.yeard}`,
            {
                headers: {
                    Authorization: "Bearer " + token,
                    "Content-Type": "application/json",
    ...
    handleYearChange = async (yeardata) => {
        ...
        const token = localStorage.getItem("token");
        const response = await axios.get(
            `http://3.89.252.45:3001/app/userMonthlyBudget/${year}`,
            {
                headers: {
                    Authorization: "Bearer " + token,
                    "Content-Type": "application/json",
